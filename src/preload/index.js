...
contextBridge.exposeInMainWorld('mdPreview', {
  ...
  openRemoteMarkdownFile: (filePath, settings) =>
    ipcRenderer.invoke('document:open-remote', { filePath, settings }),
  ...
  refreshRemoteMarkdownFolder: (settings, folderPath) =>
    ipcRenderer.invoke('document:refresh-remote-folder', { settings, folderPath }),
  ...
  createRemoteMarkdownFileInFolder: (options) =>
    ipcRenderer.invoke('document:create-remote-in-folder', options),
  createRemoteFolderInFolder: (options) =>
    ipcRenderer.invoke('document:create-remote-folder-in-folder', options),
  renameRemoteFolderItem: (options) => ipcRenderer.invoke('document:rename-remote-folder-item', options),
  duplicateRemoteFolderFile: (options) =>
    ipcRenderer.invoke('document:duplicate-remote-folder-file', options),
  ...
  showRemoteFolderItem: (settings, itemPath) =>
    ipcRenderer.invoke('document:show-remote-folder-item', { settings, itemPath }),
  saveMarkdownFile: (filePath, content, defaultFolderPath) =>
    ipcRenderer.invoke('document:save', { filePath, content, defaultFolderPath }),
  saveMarkdownFileAs: (content, defaultFolderPath) =>
    ipcRenderer.invoke('document:save-as', { content, defaultFolderPath }),
  saveRemoteMarkdownFile: (settings, filePath, content) =>
    ipcRenderer.invoke('document:save-remote', { settings, filePath, content }),
  ...
  resolveAssetUrl: (markdownFilePath, source, syncSettings) =>
    ipcRenderer.invoke('document:asset-url', { markdownFilePath, source, syncSettings }),
